...
from data import WiderFaceDetection, detection_collate, preproc, cfg_mnet, cfg_re50, cfg_effnet, cfg_vovnet, cfg_selecsls, cfg_tresnet
...
if args.network == "mobile0.25":
    ...
    cfg = cfg_effnet
elif args.network == "vovnet":
    cfg = cfg_vovnet
elif args.network == "selecsls":
    cfg = cfg_selecsls
